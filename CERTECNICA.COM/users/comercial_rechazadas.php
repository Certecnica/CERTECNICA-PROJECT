...
if($user['position_id'] == '16'){?>
    ...
    $documentos = $conexion2 -> prepare("SELECT * FROM solicitudes WHERE area = 'COMERCIAL' AND estado_JF = 'Rechazada'") ;
                  ...
                  <table id="example1" class="table table-bordered">
                    ...
                    <tbody>
                      <?php
                       ...
                       $leaves = mysqli_query($conn,"SELECT * FROM solicitudes WHERE id_user != '$id_user' AND area = 'COMERCIAL' AND estado_JF = 'Rechazada' ");
                     if($leaves){
