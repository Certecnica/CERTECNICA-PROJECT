...
<body>
    ...
    <div class="row">
        <div class="col-sm-12">
            <form action="functions_administrativa.php" method="POST">
            <div class="form-group">
    <label for="rechazo_comercial"></label>
    <input class="form-control" id="rechazo_administrativa" name="rechazo_administrativa" value="<?php echo $usuario['comentario_JF'];?>" required> 
</div>       <br>
                <br>
                ...
                <div class="boton-eliminar">    
                              ...
                              <a href="administrativa_rechazadas.php" class="btn btn-success">Cancelar</a></center>
                </div>
        </div>
    </div>
    </body>
