...
<body>
    ...
    <div class="row">
        <div class="col-sm-12">
            <form action="functions_comercial.php" method="POST">
            <div class="form-group">
    <label for="rechazo_comercial"></label>
    <input class="form-control" id="rechazo_comercial" name="rechazo_comercial" value="<?php echo $usuario['comentario_JF'];?>" required> 
</div>       <br>
                <br>
