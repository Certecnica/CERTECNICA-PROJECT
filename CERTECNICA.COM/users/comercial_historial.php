...
if($user['position_id'] == '16'){?>
    ...
    $documentos = $conexion2 -> prepare("SELECT * FROM solicitudes WHERE id_user != '$id_user' AND area = 'COMERCIAL' AND estado_JF = 'Aprobada' AND estado_JF = 'Rechazada'") ;
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered">
                    ...
                    <tbody>
                      <?php
                       global $row;
                       $leaves = mysqli_query($conn,"SELECT * FROM solicitudes  WHERE id_user != '$id_user' AND area = 'COMERCIAL'  ");
                     if($leaves){
                       ...
                       if($numrow!=0){
                        ...
                        <td>
                        <a class='btn btn-link btn-sm editar btn-flat' href="ver_solicitud_comercial.php?id=<?php echo $row1['id']?>"><i class="fa fa-eye" aria-hidden="true"> Ver Solicitud</i></a>
                        <br>
                         </td>
                          </tr>
                           <?php
