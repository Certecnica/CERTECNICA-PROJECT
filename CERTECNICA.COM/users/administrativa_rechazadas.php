...
if($user['position_id'] == '24'){?>
    ...
    $documentos = $conexion2 -> prepare("SELECT * FROM solicitudes WHERE area = 'ADMINISTRATIVA' AND estado_JF = 'Rechazada' AND estado_DA = 'Rechazada'") ;
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered">
                    ...
                    <tbody>
                      <?php
                       global $row;
                       $leaves = mysqli_query($conn,"SELECT * FROM solicitudes WHERE area = 'ADMINISTRATIVA' AND estado_JF = 'Rechazada' AND estado_DA = 'Rechazada'");
                     if($leaves){
                       ...
                       if($numrow!=0){
                        ...
                        <td>
                          <a class='btn btn-success btn-sm editar btn-flat' href="solicitud_administrativa_vista.php?id=<?php echo $row1['id']?>"><i class="fa fa-eye" aria-hidden="true"> Ver Solicitud</i></a>
                        </td> 
                          <br>
                          </tr>
                           <?php
