...
<?php 	
  ...
  include 'includes/conn.php';
   ...
   if($user['position_id'] == '24'){?>
    ...
    $documentos = $conexion2 -> prepare("SELECT * FROM solicitudes WHERE area = 'ADMINISTRATIVA' AND estado_JF = 'Aprobada'") ;
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered">
                    ...
                    <tbody>
                      <?php
                       global $row;
                       $leaves = mysqli_query($conn,"SELECT * FROM solicitudes WHERE area = 'ADMINISTRATIVA' AND estado_JF = 'Aprobada' ");
                     if($leaves){
