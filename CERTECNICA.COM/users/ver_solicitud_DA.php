...
?>
<body>
  <form  class="" action="function_comentarios_DA.php" method="POST"enctype="multipart/form-data">
  <div class="form-row">
  ...
  <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="comentario_DA" name="comentario_DA" value="<?= $usuario['comentario_JF'] ?>">
    </div>
        <div class="form-row"> 
        <br>
        </div>
...
<div class="mb-3">
    <center>
      ...
      <a href="DA_pendientes.php" class="btn btn-danger">Cancelar</a>
</div>
    </center>
</form>
