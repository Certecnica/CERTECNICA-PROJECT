...
if($user['position_id'] == '24'){?>
    ...
    $documentos = $conexion2 -> prepare("SELECT * FROM solicitudes WHERE id_user != '$id_user' AND estado_JF = 'Rechazada' AND estado_DA = 'Rechazada' ") ;
    ...
    <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <?php
                       global $row;
                       $leaves = mysqli_query($conn,"SELECT * FROM solicitudes WHERE id_user  != '$id_user' AND estado_DA = 'Rechazada'");
                     if($leaves){
                       ...
                       if($numrow!=0){
                        ...
                        <td>
                          <a class='btn btn-success btn-sm editar btn-flat' href="solicitud_DA_vista.php?id=<?php echo $row1['id']?>"><i class="fa fa-eye" aria-hidden="true"> Ver Solicitud</i></a>
                        </td> 
                          <br>
                          </tr>
                           <?php
