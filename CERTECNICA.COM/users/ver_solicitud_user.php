...
?>
<body>
  <form  class="" action="function_solicitud_user.php" method="POST"enctype="multipart/form-data">
  <div class="form-row">
  ...
  <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-4">
      ...
      <input type="text" class="form-control" id="fecha_inicio" name="fecha_inicio" value="<?= $usuario['fecha_inicio'];  ?>">
    </div>
    <div class="col-md-4 mb-3">
      <label for="correo_corporativo">FECHA FIN </label>
      <input type="text" class="form-control" id="fecha_fin" name="fecha_fin"  value="<?= $usuario['fecha_fin']?>">
      </div>

    <div class="form-row">
    <div class="form-group col-md-4">
      <label for="inputCity">DESCRIPCION</label>
      <input type="text" class="form-control" id="descripcion" name="descripcion" value="<?= $usuario['descripcion'] ?>">
    </div>
...
<div class="mb-3">
    <center>
            ...
            <a href="solicitudes_pendientes.php" class="btn btn-danger">Cancelar</a>
</div>
    </center>
</form>
