...
<body>
  ...
  <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-4">
      ...
      <input type="text" class="form-control" id="cuotas" name="cuotas" value="<?= $usuario['cuotas'];  ?>">
    </div>
    <div class="col-md-4 mb-3">
      <label for="valor_cuota_mensual">VALOR CUOTA MENSUAL</label>
      <input type="text" class="form-control" id="valor_cuota_mensual" name="valor_cuota_mensual"  value="<?php echo number_format ($usuario['valor_cuota_mensual'])?>">
      </div>

    <div class="form-row">
    <div class="form-group col-md-4">
      <label for="fecha_primer_descuento">FECHA PRIMER DESCUENTO</label>
      <input type="text" class="form-control" id="fecha_primer_descuento" name="" value="<?= $usuario['fecha_primer_descuento'] ?>">
    </div>
...
<br>
  ...
  <div class="form-group">
    ...
    <center>
            ...
            <a href="prestamos_historial.php" class="btn btn-danger">Cancelar</a>
    </center>
</form>
