...
<body>
  ...
  <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="comentario_jefe" name="comentario_jefe" value="<?= $usuario['comentario_JF'] ?>">
    </div>
        <div class="form-row"> 
        <br>
        </div>
...
<div class="mb-3">
    <center>
      ...
      <a href="administrativa_pendientes.php" class="btn btn-danger">Cancelar</a>
</div>
    </center>
</form>
