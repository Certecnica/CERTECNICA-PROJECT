                  ...
                  <table id="example1" class="table table-bordered">
                    ...
                    <tbody>
                      <?php
                       ...
                       $leaves = mysqli_query($conn,"SELECT * FROM solicitudes WHERE id_user != '$id_user' AND area = 'CALIDAD' AND estado_JF = 'Pendiente' ");
                     if($leaves){
                       ...
                       if($numrow!=0){
                        ...
                        <td>
                          <a class='btn btn-primary btn-sm editar btn-flat' href="ver_comentarios_calidad.php?id=<?php echo $row1['id']?>"><i class="fa fa-commenting-o" aria-hidden="true"></i> Añadir Comentario</a>
                          <br>
                          ...
                          <a class='btn btn-danger btn-sm rechazar btn-flat' href="comentarios_calidad.php?id=<?php echo $row1['id']?>" > Rechazar </a>
                        </td>
                          </tr>
                           <?php
                           ;
