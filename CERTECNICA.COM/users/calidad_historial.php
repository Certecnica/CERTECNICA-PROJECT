...
if($user['position_id'] == '21'){?>
    ...
    $documentos = $conexion2 -> prepare("SELECT * FROM solicitudes WHERE id_user != '$id_user'");
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered">
                    ...
                    <tbody>
                      <?php
                       global $row;
                       $leaves = mysqli_query($conn,"SELECT * FROM solicitudes  WHERE id_user != '$id_user' AND area = 'CALIDAD'  ");
                     if($leaves){
