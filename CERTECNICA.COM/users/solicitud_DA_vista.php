...
?>
<body>
  <form  class="" action="function_comentarios_comercial.php" method="POST"enctype="multipart/form-data">
  <div class="form-row">
  ...
  <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-6">
      <label for="inputState">APROBACION DIRECTOR ADMINISTRATIVO</label>
      <input type="text" class="form-control" id="jefe_area" name="jefe_area" value="<?= $usuario['estado_DA'] ?>" readonly>
    </div>

    <div class="form-group col-md-6">
      <label for="comentarios"> COMENTARIOS DIRECTOR ADMINISTRATIVO</label>
      <input type="text" class="form-control" id="comentario_jefe" name="comentario_jefe" value="<?= $usuario['comentario_DA'] ?>" readonly>
    </div>
        <div class="form-row"> 
        <br>
        </div>
...
<div class="mb-3">
    <center>
      <a href="DA_rechazadas.php" class="btn btn-danger">Cancelar</a>
</div>
    </center>
</form>
