                  ...
                  <table id="example1" class="table table-bordered">
                    ...
                    <tbody>
                      <?php
                       ...
                       $leaves = mysqli_query($conn,"SELECT * FROM solicitudes WHERE id_user != '$id_user' AND area = 'CALIDAD' AND estado_JF = 'Aprobada' ");
                     if($leaves){
                       ...
                       if($numrow!=0){
                        ...
                        <td>
                        <a class='btn btn-success btn-sm editar btn-flat' href="ver_solicitud_calidad.php?id=<?php echo $row1['id']?>"><i class="fa fa-eye" aria-hidden="true"> Ver Solicitud</i></a>
                        <br>
                         </td>
                          </tr>
                           <?php
