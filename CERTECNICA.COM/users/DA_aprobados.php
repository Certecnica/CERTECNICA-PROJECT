...
<?php 	
  ...
  include 'includes/conn.php';
   ...
   if($user['position_id'] == '24'){?>
    ...
    $documentos = $conexion2 -> prepare("SELECT * FROM solicitudes WHERE  estado_JF = 'Aprobada' AND estado_DA = 'Aprobada'") ;
                  ...
                  <table id="example1" class="table table-bordered">
                    ...
                    <tbody>
                      <?php
                       ...
                       $leaves = mysqli_query($conn,"SELECT * FROM solicitudes WHERE id_user != '$id_user' AND area = 'ADMINISTRATIVA' AND estado_JF = 'Aprobada' ");
                     if($leaves){
