...
<body>
    ...
    <div class="row">
        <div class="col-sm-12">
            <form action="functions_DA.php" method="POST">
            <div class="form-group">
    <label for="rechazo_comercial"></label>
    <input class="form-control" id="rechazo_DA" name="rechazo_DA" value="<?php echo $usuario['comentario_DA'];?>" required> 
</div>       <br>
                <br>
                ...
                <div class="boton-eliminar">    
                              ...
                              <a href="DA_pendientes.php" class="btn btn-success">Cancelar</a></center>
                </div>
        </div>
    </div>
    </body>
