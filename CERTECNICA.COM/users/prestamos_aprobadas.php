...
$documentos = $conexion2 -> prepare("SELECT * FROM solicitud_prestamo WHERE id_user = $id_user AND estado_GH = 'Aceptado' AND estado_subgerencia = 'Aceptado' AND estado_DA = 'Aceptado'") ;
