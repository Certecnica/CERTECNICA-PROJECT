...
if($user['position_id'] == '21'){?>
    ...
    $documentos = $conexion2 -> prepare("SELECT * FROM solicitudes WHERE area = 'CALIDAD' AND estado_JF = 'Rechazada'") ;
                  ...
                  <table id="example1" class="table table-bordered">
                    ...
                    <tbody>
                      <?php
                       ...
                       $leaves = mysqli_query($conn,"SELECT * FROM solicitudes WHERE id_user != '$id_user' AND area = 'CALIDAD' AND estado_JF = 'Rechazada' ");
                     if($leaves){
                        ...
                        <td>
                          <a class='btn btn-link btn-sm editar btn-flat' href="ver_solicitud_calidad.php?id=<?php echo $row1['id']?>"><i class="fa fa-eye" aria-hidden="true"> Ver Solicitud</i></a>
                        </td> 
                          <br>
                          </tr>
                           <?php
