...
?>
<body>
  <form  class="" action="function_comentarios_tecnica.php" method="POST"enctype="multipart/form-data">
  <div class="form-row">
  ...
  <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-6">
      <label for="comentario_tecnica"> COMENTARIOS </label>
      <input type="text" class="form-control" id="comentario_tecnica" name="comentario_tecnica" value="<?= $usuario['comentario_JF'] ?>">
    </div>
        <div class="form-row"> 
        <br>
        </div>
...
<div class="mb-3">
    <center>
      <button type="submit" class="btn btn-success" >Añadir comentarios</button>
      <a href="tecnica_pendientes.php" class="btn btn-danger">Cancelar</a>
</div>
    </center>
</form>
