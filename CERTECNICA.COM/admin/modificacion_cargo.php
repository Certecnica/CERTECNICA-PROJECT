        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
               <a href="#addCargo" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i> Nuevo</a>
            </div>
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                   ...
                   $SQL="SELECT *FROM modificacion_cargo";
                   ...
                   if($dato -> num_rows >0){
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?php echo $fila['Cargo_anterior']; ?></td>
                          <td><?php echo $fila['Cargo_Nuevo']; ?></td>
