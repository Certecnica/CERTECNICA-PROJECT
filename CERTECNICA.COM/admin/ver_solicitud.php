...
?>
<body>
  <form  class="" action="function_solicitud.php" method="POST"enctype="multipart/form-data">
  <div class="form-row">
  ...
  <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="comentarios" name="comentarios" value="<?= $usuario['comentario_GH'] ?>">
    </div>
        <div class="form-row"> 
        <br>
        </div>
...
<div class="mb-3">
    <center>
                               ...
                               <a href="admin_solicitudes.php" class="btn btn-danger">Cancelar</a>
                            </div>
    </center>
<style>    
.buton a{
