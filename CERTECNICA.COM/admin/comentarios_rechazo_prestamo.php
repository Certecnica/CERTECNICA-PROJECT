...
<body>
    ...
    <div class="row">
        <div class="col-sm-12">
            <form action="functions_prestamo.php" method="POST">
            <div class="form-group">
    <label for="motivo_rechazo"></label>

    <input class="form-control" id="motivo_rechazo" name="motivo_rechazo" value="<?php echo $user['comentario_GH'];?>" required> 
                ...
                <div class="boton-eliminar">    
                              ...
                              <a href="prestamos_pendientes.php" class="btn btn-success">Cancelar</a></center>
                </div>
        </div>
    </div>
    </body>
