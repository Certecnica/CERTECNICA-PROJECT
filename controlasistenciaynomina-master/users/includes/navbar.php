<header class="main-header">
    ...
    <a href="home.php" class="logo">
      ...
      <span class="logo-lg"><b>CERTECNICA</b></span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="<?php echo (!empty($user['photo'])) ? '../images/'.$user['photo'] : '../images/certecnica-sinfondo.jpg'; ?>" class="img-circle" alt="User Image">
